...
def psd_welch_contaldi_2023(data:npt.NDArray, fs:float) -> typing.Tuple[npt.NDArray, npt.NDArray]:
...
def psd_welch_gilron_2021(data:npt.NDArray, fs:float=250) -> typing.Tuple[npt.NDArray, npt.NDArray]:
...
def psd_calculation_manual(data: npt.NDArray, fs: float, nperseg: int = None) -> typing.Tuple[npt.NDArray, npt.NDArray]:
