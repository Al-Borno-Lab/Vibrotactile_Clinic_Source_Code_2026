...
class Patient_3(PatientObjAbstractBase):
    # TODO: Patient 3 needs some additinoal processing to fix the artifact issue.
    def __init__(self, data_dir: Union[str, Path] = None):
        ...
        self.stage_mapping = {
            ...
            str(constants.TreatmentStage.ALL_ON): range(19, 22),
        }
        self.treatment_order = str(constants.TreatmentStageOrder.RVS_THEN_ALLON)
        self.glove_hand = str(constants.StimGloveHand.LEFT)
        self.json_filenames = [
            "Report_Json_Session_Report_20240528T174157.json",
            "Report_Json_Session_Report_20240528T174146.json",
        ]
