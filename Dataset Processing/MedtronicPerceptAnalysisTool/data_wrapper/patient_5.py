...
class Patient_5(PatientObjAbstractBase):
    def __init__(self, data_dir: Union[str, Path] = None):
        ...
        self.stage_mapping = {
            ...
            str(constants.TreatmentStage.ALL_ON): range(7, 19),
        ...
        self.json_filenames = [
            "Report_Json_Session_Report_20240715T114410.json",
            "Report_Json_Session_Report_20240715T114352.json",
        ]
